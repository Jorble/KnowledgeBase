...
@ActivityScope
@Component(modules = MainTabFavorModule.class, dependencies = AppComponent.class)
public interface MainTabFavorComponent {
    void inject(MainTabFavorFragment mainTabFavorFragment);
}