...
@ActivityScope
@Component(modules = MainTabHomeModule.class, dependencies = AppComponent.class)
public interface MainTabHomeComponent {
    void inject(MainTabHomeFragment mainTabHomeFragment);
}