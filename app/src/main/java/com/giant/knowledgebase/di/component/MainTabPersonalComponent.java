...
@ActivityScope
@Component(modules = MainTabPersonalModule.class, dependencies = AppComponent.class)
public interface MainTabPersonalComponent {
    void inject(MainTabPersonalFragment mainTabPersonalFragment);
}