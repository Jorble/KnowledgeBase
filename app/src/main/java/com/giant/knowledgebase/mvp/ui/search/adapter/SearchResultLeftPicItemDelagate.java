 ...
 */
public class SearchResultLeftPicItemDelagate implements ItemViewDelegate<NewsBean>
{
    private Context context;

    public SearchResultLeftPicItemDelagate(Context context){
    ...
    {
        return R.layout.item_search_result_leftpic;
    }
