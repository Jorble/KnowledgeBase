 ...
 * 描述:
 */
public class LikeHistoryRecyclerViewAdapter extends BGARecyclerViewAdapter<LikeHistoryJson.LikeHistoryListBean> {
    Context context;

    public LikeHistoryRecyclerViewAdapter(Context context, RecyclerView recyclerView) {
...
//        viewHolderHelper.setItemChildClickListener(R.id.share_ll);
    ...
    @Override
    public void fillData(BGAViewHolderHelper viewHolderHelper, int position, LikeHistoryJson.LikeHistoryListBean model) {
        viewHolderHelper
