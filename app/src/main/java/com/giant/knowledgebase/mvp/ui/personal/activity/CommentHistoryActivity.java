...
import com.giant.knowledgebase.mvp.model.entity.CommentHistoryJson;
...
import com.giant.knowledgebase.mvp.ui.personal.adapter.CommentHistoryRecyclerViewAdapter;
...
public class CommentHistoryActivity extends AppCompatActivity implements  BGAOnRVItemClickListener, BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    private CommentHistoryRecyclerViewAdapter mAdapter;
    ...
    public void initRefreshLayout() {
        ...
        mAdapter = new CommentHistoryRecyclerViewAdapter(this, recylerView);
...
//        recylerView.setLayoutManager(new GridLayoutManager(mApp, 2, GridLayoutManager.VERTICAL, false));
    ...
    public void onBGARefreshLayoutBeginRefreshing(BGARefreshLayout mrefreshLayout) {
        ...
        new Handler().postDelayed(() -> {
            Request request = HistoryService.getCommentHistoryList(1, 20);
            ItheimaHttp.send(request, new HttpResponseListener<CommentHistoryJson>() {
                @Override
                public void onResponse(CommentHistoryJson jsonBean, Headers headers) {
                    L.i("onResponse");
                    refreshLayout.endRefreshing();
                    if (jsonBean == null) return;

                    if (CODE_SUCCESS == jsonBean.getErrCode()) {
                        mAdapter.setData(jsonBean.getCommentHistoryList());
                        showContent();
        ...
        new Handler().postDelayed(() -> {
            ...
            ItheimaHttp.send(request, new HttpResponseListener<CommentHistoryJson>() {
                ...
                public void onResponse(CommentHistoryJson jsonBean, Headers headers) {
                    ...
                    if (jsonBean == null) return;
                    mAdapter.addMoreData(jsonBean.getCommentHistoryList());
                }
                ...
                public void onFailure(Call<ResponseBody> call, Throwable e) {
                    L.i("onFailure");
                    refreshLayout.endLoadingMore();
                    T.showShort(CommentHistoryActivity.this, "加载失败");
                }
    ...
    public void onRVItemClick(ViewGroup parent, View itemView, int position) {
        ...
        ItheimaHttp.send(request, new HttpResponseListener<NewsBean>() {
            ...
            public void onResponse(NewsBean jsonBean, Headers headers) {
                ...
                Intent intent = new Intent(CommentHistoryActivity.this, NewsDetailsActivity.class);
            ...
            public void onFailure(Call<ResponseBody> call, Throwable e) {
                L.i("onFailure");
                T.showShort(CommentHistoryActivity.this, "获取详情失败");
            }
