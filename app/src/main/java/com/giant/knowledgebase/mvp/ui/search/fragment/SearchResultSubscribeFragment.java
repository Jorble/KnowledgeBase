...
/**
 * Use the {@link SearchResultSubscribeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SearchResultSubscribeFragment extends Fragment implements BGAOnRVItemClickListener, BGAOnItemChildClickListener,BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    public SearchResultSubscribeFragment() {
    ...
    public static SearchResultSubscribeFragment newInstance() {
        SearchResultSubscribeFragment fragment = new SearchResultSubscribeFragment();
        return fragment;
    }
...
//        recylerView.setLayoutManager(new GridLayoutManager(mApp, 2, GridLayoutManager.VERTICAL, false));
    ...
    private void initAdapter(){
        mAdapter = new SubscribeAddRecyclerViewAdapter(getContext(),recylerView);
        //item点击
    ...
    public void onRVItemClick(ViewGroup parent, View itemView, int position) {
        //进入订阅号详情
        T.showShort(getContext(),"进入订阅号详情");
    }
