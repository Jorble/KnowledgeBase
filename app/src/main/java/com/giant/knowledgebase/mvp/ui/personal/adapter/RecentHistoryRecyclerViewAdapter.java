 ...
 * 描述:
 */
public class RecentHistoryRecyclerViewAdapter extends BGARecyclerViewAdapter<RecentHistoryJson.RecentHistoryListBean> {
    Context context;

    public RecentHistoryRecyclerViewAdapter(Context context, RecyclerView recyclerView) {
...
//        viewHolderHelper.setItemChildClickListener(R.id.share_ll);
    ...
    @Override
    public void fillData(BGAViewHolderHelper viewHolderHelper, int position, RecentHistoryJson.RecentHistoryListBean model) {
        viewHolderHelper
