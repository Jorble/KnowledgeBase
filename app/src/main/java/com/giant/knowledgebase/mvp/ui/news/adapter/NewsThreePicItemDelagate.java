 ...
 */
public class NewsThreePicItemDelagate implements ItemViewDelegate<NewsBean> {

    private Context context;
    private NewsRvMultiAdapter mAdapter;
    private CustomPopWindow sharePopWindow;

    public NewsThreePicItemDelagate(Context context, NewsRvMultiAdapter mAdapter) {
    ...
    public int getItemViewLayoutId() {
        return R.layout.item_news_threepic;
    }
