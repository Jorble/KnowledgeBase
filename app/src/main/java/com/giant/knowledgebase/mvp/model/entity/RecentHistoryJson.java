...
public class RecentHistoryJson {
    ...
    public List<RecentHistoryListBean> getRecentHistoryList() {
        return recentHistoryList;
    }

    public void setRecentHistoryList(List<RecentHistoryListBean> recentHistoryList) {
        this.recentHistoryList = recentHistoryList;
    }

    public static class RecentHistoryListBean {
        /**
         * title : helloworld
         * objid : 9688
         * author : test33
