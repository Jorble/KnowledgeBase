 ...
 */
public class NewsLeftPicItemDelagate implements ItemViewDelegate<NewsBean> {

    private Context context;
    private NewsRvMultiAdapter mAdapter;
    private CustomPopWindow sharePopWindow;

    public NewsLeftPicItemDelagate(Context context, NewsRvMultiAdapter mAdapter) {
    ...
    public int getItemViewLayoutId() {
        return R.layout.item_news_leftpic;
    }
