 ...
 * 描述:
 */
public class ShareHistoryRecyclerViewAdapter extends BGARecyclerViewAdapter<ShareHistoryJson.ShareHistoryListBean> {
    Context context;

    public ShareHistoryRecyclerViewAdapter(Context context, RecyclerView recyclerView) {
...
//        viewHolderHelper.setItemChildClickListener(R.id.share_ll);
    ...
    @Override
    public void fillData(BGAViewHolderHelper viewHolderHelper, int position, ShareHistoryJson.ShareHistoryListBean model) {
        viewHolderHelper
