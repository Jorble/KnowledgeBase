 ...
 */
public class NewsSinglePicItemDelagate implements ItemViewDelegate<NewsBean> {

    private Context context;
    private NewsRvMultiAdapter mAdapter;
    private CustomPopWindow sharePopWindow;

    public NewsSinglePicItemDelagate(Context context, NewsRvMultiAdapter mAdapter) {
    ...
    public int getItemViewLayoutId() {
        return R.layout.item_news_singlepic;
    }
