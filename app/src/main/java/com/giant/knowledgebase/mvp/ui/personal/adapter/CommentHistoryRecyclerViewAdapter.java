 ...
 * 描述:
 */
public class CommentHistoryRecyclerViewAdapter extends BGARecyclerViewAdapter<CommentHistoryJson.CommentHistoryListBean> {
    Context context;

    public CommentHistoryRecyclerViewAdapter(Context context, RecyclerView recyclerView) {
        super(recyclerView, R.layout.item_comment_history_list);
...
//        viewHolderHelper.setItemChildClickListener(R.id.share_ll);
    ...
    @Override
    public void fillData(BGAViewHolderHelper viewHolderHelper, int position, CommentHistoryJson.CommentHistoryListBean model) {
        viewHolderHelper
                .setText(R.id.title_tv, model.getTitle())
                .setText(R.id.comment_tv, model.getComment());
